...
if not context_manager.has_current_workflow():
    context_manager.push_workflow(workflow_name="no_control_flow_test")
...
top_level_unique_values_dict = {
    "608df979-7daa-4d2f-90c5-6551a624db19": pickle.loads(b"\x80\x04\x95\x04\x00\x00\x00\x00\x00\x00\x00\x8c\x00\x94.")
}
    ...
    with GriptapeNodes.ContextManager().node(node0_name):
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                ...
                value=top_level_unique_values_dict["608df979-7daa-4d2f-90c5-6551a624db19"],
                initial_setup=True,
                is_output=False,
            )
        )
