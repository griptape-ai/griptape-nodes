...
cmd.create_node(node_type="TextInput"    , node_name="detail_prompt"        , metadata={'position': {'x': -631, 'y': 686}  , 'size': {'width': 640, 'height': 329}})
cmd.create_node(node_type="GenerateImage", node_name="enhanced_prompt_image", metadata={'position': {'x':   684, 'y':  188}})
...
cmd.create_node(node_type="GenerateImage", node_name="bespoke_prompt_image" , metadata={'position': {'x':  1972, 'y':  189}})
...
cmd.set_value("basic_image.output"                  , {'type': 'ImageArtifact', 'id': 'a1d85e8dfa5745b7a39be55cca4660fb', 'reference': None, 'meta': {'model': 'dall-e-3', 'prompt': 'A capybara eating with utensils'}, 'name': 'image_artifact_250411205314_ll63.png', 'value': '<Image data omitted - 20 bytes>', 'format': 'png', 'width': 1024, 'height': 1024})
cmd.set_value("basic_image.logs"                    , "Node hasn't begun yet")
cmd.set_value("detail_prompt.text"                  , 'Enhance the following prompt for an image generation engine. Return only the image generation prompt.\nInclude unique details that make the subject stand out.\nSpecify a specific depth of field, and time of day.\nUse dust in the air to create a sense of depth.\nUse a slight vignetting on the edges of the image.\nUse a color palette that is complementary to the subject.\nFocus on qualities that will make this the most professional looking photo in the world.\n')
...
cmd.set_value("assemble_prompt.input_1"             , 'Enhance the following prompt for an image generation engine. Return only the image generation prompt.\nInclude unique details that make the subject stand out.\nSpecify a specific depth of field, and time of day.\nUse dust in the air to create a sense of depth.\nUse a slight vignetting on the edges of the image.\nUse a color palette that is complementary to the subject.\nFocus on qualities that will make this the most professional looking photo in the world.\n')
