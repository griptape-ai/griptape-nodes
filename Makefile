...
fix: ## Fix project.
	@make format
	@uv run ruff check --fix --unsafe-fixes --exclude "libraries/**/tests/**/*" --exclude "libraries/griptape_nodes_library/workflows/templates/**/*" --exclude "libraries/griptape_cloud/workflows/templates/**/*"
...
.PHONY: check/lint
check/lint:
	@uv run ruff check --exclude "libraries/**/tests/**/*" --exclude "libraries/griptape_nodes_library/workflows/templates/**/*" --exclude "libraries/griptape_cloud/workflows/templates/**/*"
