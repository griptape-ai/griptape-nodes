"""Unit tests for DataUriFileReadDriver."""
...
class TestDataUriFileReadDriver:
    """Tests for DataUriFileReadDriver class."""

    @pytest.fixture
    def driver(self) -> DataUriFileReadDriver:
        """Create a DataUriFileReadDriver instance."""
        return DataUriFileReadDriver()
    ...
    def test_can_handle_data_uris(self, driver: DataUriFileReadDriver) -> None:
    ...
    def test_can_handle_rejects_other_schemes(self, driver: DataUriFileReadDriver) -> None:
    ...
    @pytest.mark.asyncio
    async def test_read_valid_data_uri(self, driver: DataUriFileReadDriver, sample_data_uri: str) -> None:
        """Test reading a valid data URI."""
        content = await driver.read(sample_data_uri, timeout=0)
        assert content == b"Hello, World!"

    @pytest.mark.asyncio
    async def test_read_image_data_uri(self, driver: DataUriFileReadDriver, sample_image_uri: str) -> None:
    ...
    @pytest.mark.asyncio
    async def test_read_invalid_data_uri_no_prefix(self, driver: DataUriFileReadDriver) -> None:
    ...
    @pytest.mark.asyncio
    async def test_read_invalid_data_uri_no_base64_marker(self, driver: DataUriFileReadDriver) -> None:
    ...
    @pytest.mark.asyncio
    async def test_read_invalid_base64_encoding(self, driver: DataUriFileReadDriver) -> None:
    ...
    @pytest.mark.asyncio
    async def test_read_ignores_timeout(self, driver: DataUriFileReadDriver, sample_data_uri: str) -> None:
    ...
    @pytest.mark.asyncio
    async def test_exists_for_valid_data_uri(self, driver: DataUriFileReadDriver, sample_data_uri: str) -> None:
        """Test exists returns True for valid data URI."""
        assert await driver.exists(sample_data_uri) is True

    @pytest.mark.asyncio
    async def test_exists_for_invalid_data_uri(self, driver: DataUriFileReadDriver) -> None:
        """Test exists returns False for invalid data URI."""
        assert await driver.exists("data:image/png,invalid") is False

    def test_get_size_for_valid_data_uri(self, driver: DataUriFileReadDriver, sample_data_uri: str) -> None:
        """Test get_size returns correct size for valid data URI."""
        size = driver.get_size(sample_data_uri)
        assert size == len(b"Hello, World!")

    def test_get_size_for_image_uri(self, driver: DataUriFileReadDriver, sample_image_uri: str) -> None:
        """Test get_size returns correct size for image data URI."""
        size = driver.get_size(sample_image_uri)
        # 1x1 PNG is 67 bytes
        assert size > 0

    def test_get_size_for_invalid_data_uri(self, driver: DataUriFileReadDriver) -> None:
        """Test get_size raises ValueError for invalid data URI."""
        with pytest.raises(ValueError, match="must contain ';base64,'"):
            driver.get_size("data:image/png,invalid")

    @pytest.mark.asyncio
    async def test_read_different_mime_types(self, driver: DataUriFileReadDriver) -> None:
