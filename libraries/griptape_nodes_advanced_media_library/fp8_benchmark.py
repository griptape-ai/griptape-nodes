...
def print_benchmark_table(standard_stats, fp8_stats):
    ...
    print(f"{'Average Time (s)':<20} {standard_stats['average_time']:<15.2f} {fp8_stats['average_time']:<15.2f} {avg_speedup:<10.2f}x")
    print(f"{'Min Time (s)':<20} {standard_stats['min_time']:<15.2f} {fp8_stats['min_time']:<15.2f} {min_speedup:<10.2f}x")
    print(f"{'Max Time (s)':<20} {standard_stats['max_time']:<15.2f} {fp8_stats['max_time']:<15.2f} {max_speedup:<10.2f}x")
    print("="*60)
