...
from caching_benchmark import benchmark_pipeline, print_benchmark_table
...
if __name__ == "__main__":
    ...
    # first run
    pipeline_1 = load_bf16_pipeline_with_official_caching(None)
    pipeline_stats_1, artifact_bytes = benchmark_pipeline(pipeline_1)

    #second run 
    pipeline_2 = load_bf16_pipeline_with_official_caching(artifact_bytes)
    pipeline_stats_2, artifact_bytes = benchmark_pipeline(pipeline_2)
    print(pipeline_stats_1)
    print(pipeline_stats_2)
