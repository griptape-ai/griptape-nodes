...
tensorrt_lib_path = (
    r"C:\Users\dev\griptape-nodes\libraries\griptape_nodes_advanced_media_library\.venv\Lib\site-packages\tensorrt_libs"
)
...
def benchmark_optimized():
    ...
    for batch, h, w, desc in test_configs:
        ...
        try:
            ...
            results.append({"config": desc, "pytorch": pytorch_time, "optimized": opt_time, "speedup": speedup})
