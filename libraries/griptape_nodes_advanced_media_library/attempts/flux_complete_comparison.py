...
class FluxComparison:
    ...
    def benchmark_inference_speed(
        self, prompt: str = "A futuristic city at sunset", num_tests: int = 2
    ) -> Dict[str, Any]:
        ...
        for i in range(num_tests):
            ...
            result = self.generate_and_time(prompt=prompt, num_inference_steps=20, height=1024, width=1024)
...
def test_all_configurations():
    ...
    if successful_results:
        ...
        for config_name, result in successful_results.items():
            ...
            print(
                f"{config_name:<20} {result['model_memory_gb']:<11.2f}G {result['first_inference_time']:<9.2f}s "
