...
def print_unclip_pipeline_memory_footprint(
    pipe: diffusers.UnCLIPPipeline,  # type: ignore[reportMissingImports]
) -> None:
    """Print memory footprint for the main sub-modules of UnCLIP pipelines."""
...
def optimize_unclip_pipeline_memory_footprint(
    ...
    pipelines but adapted to the component layout of UnCLIP.
    """
