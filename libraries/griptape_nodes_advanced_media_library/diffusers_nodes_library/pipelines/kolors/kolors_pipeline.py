...
from diffusers_nodes_library.pipelines.kolors.kolors_pipeline_memory_footprint import (
    optimize_kolors_pipeline_memory_footprint,  # type: ignore[reportMissingImports]
    print_kolors_pipeline_memory_footprint,  # type: ignore[reportMissingImports]
)
from diffusers_nodes_library.pipelines.kolors.kolors_pipeline_parameters import (
    KolorsPipelineParameters,  # type: ignore[reportMissingImports]
)
...
class KolorsPipeline(ControlNode):
    """Griptape wrapper around diffusers.pipelines.kolors.KolorsPipeline."""

    def __init__(self, **kwargs) -> None:
        super().__init__(**kwargs)
        self.pipe_params = KolorsPipelineParameters(self)
    ...
    def _process(self) -> AsyncResult | None:
        ...
        with self.log_params.append_profile_to_logs("Loading model metadata"):
            ...
            pipe: diffusers.KolorsPipeline = model_cache.from_pretrained(
        ...
        with (
            ...
            optimize_kolors_pipeline_memory_footprint(pipe)
        ...
        logger.info("Kolors memory footprint after inference:")
