...
class DeepfloydIfPipelineParameters:
    """Wrapper around the collection of parameters needed for DeepFloyd IF pipelines."""
    ...
    def add_input_parameters(self) -> None:
        ...
        self._node.add_parameter(
            Parameter(
                ...
                input_types=["int"],
                type="int",
                tooltip="Width in pixels (stage 1 resolution)",
            )
        )
        self._node.add_parameter(
            Parameter(
                ...
                input_types=["int"],
                type="int",
                tooltip="Height in pixels (stage 1 resolution)",
            )
        )
        self._node.add_parameter(
            Parameter(
