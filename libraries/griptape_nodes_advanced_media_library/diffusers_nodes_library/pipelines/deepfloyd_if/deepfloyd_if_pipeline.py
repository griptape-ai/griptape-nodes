...
from diffusers_nodes_library.pipelines.deepfloyd_if.deepfloyd_if_pipeline_parameters import (
    DeepfloydIfPipelineParameters,  # type: ignore[reportMissingImports]
)
...
class DeepfloydIfPipeline(ControlNode):
    """Griptape wrapper around diffusers.IFPipeline."""

    def __init__(self, **kwargs) -> None:
        super().__init__(**kwargs)
        self.pipe_params = DeepfloydIfPipelineParameters(self)
    ...
    def _process(self) -> AsyncResult | None:
        ...
        with self.log_params.append_profile_to_logs("Loading model metadata"):
            ...
            pipe: diffusers.IFPipeline = model_cache.from_pretrained(
        ...
        with (
            ...
            optimize_deepfloyd_if_pipeline_memory_footprint(pipe)
        ...
        logger.info("DeepFloyd IF memory footprint after inference:")
        print_deepfloyd_if_pipeline_memory_footprint(pipe)
