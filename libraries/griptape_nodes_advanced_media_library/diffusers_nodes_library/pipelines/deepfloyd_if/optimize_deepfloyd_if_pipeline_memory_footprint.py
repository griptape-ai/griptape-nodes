...
def print_deepfloyd_if_pipeline_memory_footprint(
    pipe: diffusers.IFPipeline,  # type: ignore[reportMissingImports]
) -> None:
    """Print memory footprint for the main sub-modules of DeepFloyd IF pipelines."""
...
def optimize_deepfloyd_if_pipeline_memory_footprint(
    ...
    pipelines but adapted to the component layout of DeepFloyd IF.
    """
