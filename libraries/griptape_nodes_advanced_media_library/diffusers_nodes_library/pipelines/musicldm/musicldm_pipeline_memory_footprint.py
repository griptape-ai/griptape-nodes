...
def print_musicldm_pipeline_memory_footprint(pipe: diffusers.MusicLDMPipeline) -> None:
...
@cache
def optimize_musicldm_pipeline_memory_footprint(pipe: diffusers.MusicLDMPipeline) -> None:
    ...
    print_musicldm_pipeline_memory_footprint(pipe)
