...
from diffusers_nodes_library.pipelines.musicldm.musicldm_pipeline_memory_footprint import (
    optimize_musicldm_pipeline_memory_footprint,
)  # type: ignore[reportMissingImports]
from diffusers_nodes_library.pipelines.musicldm.musicldm_pipeline_parameters import (
    MusicldmPipelineParameters,  # type: ignore[reportMissingImports]
)
...
class MusicldmPipeline(ControlNode):
    """Griptape wrapper around diffusers.MusicLDMPipeline."""

    def __init__(self, **kwargs) -> None:
        super().__init__(**kwargs)
        self.pipe_params = MusicldmPipelineParameters(self)
    ...
    def _process(self) -> AsyncResult | None:
        self.preprocess()
        self.log_params.append_to_logs("Preparing MusicLDM models...\n")
        ...
        with self.log_params.append_profile_to_logs("Loading model"), self.log_params.append_logs_to_logs(logger):
            optimize_musicldm_pipeline_memory_footprint(pipe)
