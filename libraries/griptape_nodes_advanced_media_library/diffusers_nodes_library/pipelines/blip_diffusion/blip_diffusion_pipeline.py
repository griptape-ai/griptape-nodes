...
from diffusers_nodes_library.pipelines.blip_diffusion.blip_diffusion_pipeline_memory_footprint import (
    optimize_blip_diffusion_pipeline_memory_footprint,
)  # type: ignore[reportMissingImports]
from diffusers_nodes_library.pipelines.blip_diffusion.blip_diffusion_pipeline_parameters import (
    BlipDiffusionPipelineParameters,  # type: ignore[reportMissingImports]
)
...
class BlipDiffusionPipeline(ControlNode):
    """Griptape wrapper around diffusers.pipelines.blip_diffusion.BlipDiffusionPipeline."""
    
    def __init__(self, **kwargs) -> None:
        super().__init__(**kwargs)
        self.pipe_params = BlipDiffusionPipelineParameters(self)
    ...
    def _process(self) -> AsyncResult | None:
        ...
        self.log_params.append_to_logs("Preparing BLIP-Diffusion models...\n")
        ...
        def callback_on_step_end(
            pipe: diffusers.BlipDiffusionPipeline,
            i: int,
            _t: Any,
