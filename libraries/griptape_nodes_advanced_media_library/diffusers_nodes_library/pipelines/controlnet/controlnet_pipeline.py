...
from diffusers_nodes_library.pipelines.controlnet.controlnet_pipeline_memory_footprint import (
    optimize_controlnet_pipeline_memory_footprint,
)  # type: ignore[reportMissingImports]
from diffusers_nodes_library.pipelines.controlnet.controlnet_pipeline_parameters import (
    ControlnetPipelineParameters,  # type: ignore[reportMissingImports]
)
...
class ControlnetPipeline(ControlNode):
    """Griptape wrapper around diffusers.pipelines.controlnet.StableDiffusionControlNetPipeline."""

    def __init__(self, **kwargs) -> None:
        super().__init__(**kwargs)
        self.pipe_params = ControlnetPipelineParameters(self)
    ...
    def _process(self) -> AsyncResult | None:
        ...
        with self.log_params.append_profile_to_logs("Loading model"), self.log_params.append_logs_to_logs(logger):
            optimize_controlnet_pipeline_memory_footprint(pipe)
