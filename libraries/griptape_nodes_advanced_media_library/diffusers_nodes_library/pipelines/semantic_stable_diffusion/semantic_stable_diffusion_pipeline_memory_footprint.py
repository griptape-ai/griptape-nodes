...
def print_semantic_stable_diffusion_pipeline_memory_footprint(pipe: diffusers.SemanticStableDiffusionPipeline) -> None:
...
@cache
def optimize_semantic_stable_diffusion_pipeline_memory_footprint(pipe: diffusers.SemanticStableDiffusionPipeline) -> None:
    ...
    print_semantic_stable_diffusion_pipeline_memory_footprint(pipe)
