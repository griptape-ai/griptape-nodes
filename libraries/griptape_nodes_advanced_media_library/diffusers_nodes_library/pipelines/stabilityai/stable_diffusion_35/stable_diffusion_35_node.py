...
from diffusers_nodes_library.pipelines.stabilityai.stable_diffusion_35.helpers.sd35_pipeline_parameters import (
    SD3PipelineParameters,
)
...
class StableDiffusion35Pipeline(ControlNode):
    ...
    def _process(self) -> AsyncResult | None:
        ...
        def callback_on_step_end(pipe: Any, step: int, _timestep: Any, callback_kwargs: dict) -> dict:
