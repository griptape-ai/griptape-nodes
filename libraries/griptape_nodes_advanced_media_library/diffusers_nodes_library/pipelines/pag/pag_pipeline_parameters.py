...
class PagPipelineParameters:
    ...
    def add_input_parameters(self) -> None:
        ...
        self._node.add_parameter(
            Parameter(
                name="pag_adaptive_scale",
                default_value=0.0,
                input_types=["float"],
                type="float",
                tooltip="pag_adaptive_scale",
            )
        )
    ...
    def get_pag_scale(self) -> float:
        return float(self._node.get_parameter_value("pag_scale"))

    def get_pag_adaptive_scale(self) -> float:
        return float(self._node.get_parameter_value("pag_adaptive_scale"))
    ...
    def get_pipe_kwargs(self) -> dict:
        return {
            ...
            "pag_scale": self.get_pag_scale(),
            "pag_adaptive_scale": self.get_pag_adaptive_scale(),
            "generator": self._seed_parameter.get_generator(),
        }

    def latents_to_image_pil(self, pipe: diffusers.StableDiffusionXLPAGPipeline, latents: Any) -> Image:
    ...
    def publish_output_image_preview_latents(self, pipe: diffusers.StableDiffusionXLPAGPipeline, latents: Any) -> None:
