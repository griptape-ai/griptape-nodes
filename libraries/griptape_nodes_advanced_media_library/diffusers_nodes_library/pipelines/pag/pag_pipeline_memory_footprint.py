...
def print_pag_pipeline_memory_footprint(pipe: diffusers.StableDiffusionXLPAGPipeline) -> None:
...
@cache
def optimize_pag_pipeline_memory_footprint(pipe: diffusers.StableDiffusionXLPAGPipeline) -> None:
    ...
    print_pag_pipeline_memory_footprint(pipe)
