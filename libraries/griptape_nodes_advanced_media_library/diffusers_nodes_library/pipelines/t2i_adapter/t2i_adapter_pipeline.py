...
from diffusers_nodes_library.pipelines.t2i_adapter.t2i_adapter_pipeline_memory_footprint import (
    optimize_t2i_adapter_pipeline_memory_footprint,
)  # type: ignore[reportMissingImports]
from diffusers_nodes_library.pipelines.t2i_adapter.t2i_adapter_pipeline_parameters import (
    T2IAdapterPipelineParameters,  # type: ignore[reportMissingImports]
)
...
class T2IAdapterPipeline(ControlNode):
    """Griptape wrapper around diffusers.StableDiffusionAdapterPipeline."""

    def __init__(self, **kwargs) -> None:
        super().__init__(**kwargs)
        self.pipe_params = T2IAdapterPipelineParameters(self)
    ...
    def _process(self) -> AsyncResult | None:
        ...
        self.log_params.append_to_logs("Preparing T2I-Adapter models...\n")
        ...
        with self.log_params.append_profile_to_logs("Loading model metadata"):
            ...
            adapter_repo_id, adapter_revision = self.pipe_params.get_adapter_repo_revision()
            ...
            pipe = model_cache.from_pretrained(
                diffusers.StableDiffusionAdapterPipeline,
        ...
        with self.log_params.append_profile_to_logs("Loading model"), self.log_params.append_logs_to_logs(logger):
            optimize_t2i_adapter_pipeline_memory_footprint(pipe)
