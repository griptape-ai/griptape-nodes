...
def print_kandinsky_pipeline_memory_footprint(
    ...
    """Print memory footprint for the main sub-modules of Kandinsky pipelines."""
...
def optimize_kandinsky_pipeline_memory_footprint(
    ...
    pipelines but adapted to the component layout of Kandinsky.
    """
