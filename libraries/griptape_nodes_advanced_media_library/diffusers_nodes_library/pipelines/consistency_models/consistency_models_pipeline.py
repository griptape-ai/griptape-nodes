...
from diffusers_nodes_library.pipelines.consistency_models.consistency_models_pipeline_memory_footprint import (
...
class ConsistencyModelsPipeline(ControlNode):
    ...
    def _process(self) -> AsyncResult | None:
        ...
        self.log_params.append_to_logs("Preparing Consistency Models...\n")
        ...
        with self.log_params.append_profile_to_logs("Loading model"), self.log_params.append_logs_to_logs(logger):
            optimize_consistency_models_pipeline_memory_footprint(pipe)
