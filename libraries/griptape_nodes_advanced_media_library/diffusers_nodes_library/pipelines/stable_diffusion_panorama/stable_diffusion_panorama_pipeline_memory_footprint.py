...
def print_stable_diffusion_panorama_pipeline_memory_footprint(pipe: diffusers.StableDiffusionPanoramaPipeline) -> None:
...
def optimize_stable_diffusion_panorama_pipeline_memory_footprint(
    ...
    print_stable_diffusion_panorama_pipeline_memory_footprint(pipe)
