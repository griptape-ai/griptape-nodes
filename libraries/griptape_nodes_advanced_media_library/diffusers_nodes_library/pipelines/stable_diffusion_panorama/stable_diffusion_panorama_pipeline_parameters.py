...
class StableDiffusionPanoramaPipelineParameters:
    ...
    def add_input_parameters(self) -> None:
        ...
        self._node.add_parameter(
            Parameter(
                ...
                input_types=["str"],
                type="str",
                tooltip="Text prompt describing the panoramic image to generate",
            )
        )
        self._node.add_parameter(
            Parameter(
        ...
        self._node.add_parameter(
            Parameter(
                ...
                input_types=["int"],
                type="int",
                tooltip="Height of the generated panoramic image in pixels",
            )
        )
        self._node.add_parameter(
            Parameter(
                ...
                input_types=["int"],
                type="int",
                tooltip="Width of the generated panoramic image in pixels (typically 2048 for panoramas)",
            )
        )
        self._node.add_parameter(
            Parameter(
                name="view_batch_size",
                default_value=16,
                input_types=["int"],
                type="int",
                tooltip="Number of views to process in each batch for panorama generation",
            )
        )
