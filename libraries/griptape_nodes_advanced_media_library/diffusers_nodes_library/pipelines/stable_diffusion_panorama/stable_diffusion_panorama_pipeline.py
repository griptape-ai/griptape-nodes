...
from diffusers_nodes_library.pipelines.stable_diffusion_panorama.stable_diffusion_panorama_pipeline_memory_footprint import (
    optimize_stable_diffusion_panorama_pipeline_memory_footprint,
)  # type: ignore[reportMissingImports]
from diffusers_nodes_library.pipelines.stable_diffusion_panorama.stable_diffusion_panorama_pipeline_parameters import (
    StableDiffusionPanoramaPipelineParameters,  # type: ignore[reportMissingImports]
)
...
class StableDiffusionPanoramaPipeline(ControlNode):
    """Griptape wrapper around diffusers.StableDiffusionPanoramaPipeline."""

    def __init__(self, **kwargs) -> None:
        super().__init__(**kwargs)
        self.pipe_params = StableDiffusionPanoramaPipelineParameters(self)
    ...
    def _process(self) -> AsyncResult | None:
        ...
        self.log_params.append_to_logs("Preparing Stable Diffusion Panorama models...\n")
        ...
        with self.log_params.append_profile_to_logs("Loading model"), self.log_params.append_logs_to_logs(logger):
            optimize_stable_diffusion_panorama_pipeline_memory_footprint(pipe)
