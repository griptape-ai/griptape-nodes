...
def print_pixart_alpha_pipeline_memory_footprint(
    pipe: diffusers.PixArtAlphaPipeline,  # type: ignore[reportMissingImports]
) -> None:
    """Print memory footprint for the main sub-modules of PixArt Alpha pipelines."""
...
def optimize_pixart_alpha_pipeline_memory_footprint(
    ...
    pipelines but adapted to the component layout of PixArt Alpha.
    """
