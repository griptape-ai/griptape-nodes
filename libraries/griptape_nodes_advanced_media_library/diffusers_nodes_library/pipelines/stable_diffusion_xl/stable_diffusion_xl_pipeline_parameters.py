...
class StableDiffusionXLPipelineParameters:
    ...
    def add_input_parameters(self) -> None:
        ...
        self._node.add_parameter(
            Parameter(
                ...
                input_types=["str"],
                type="str",
                tooltip="Optional second prompt for dual text encoders",
            )
        )
        self._node.add_parameter(
            Parameter(
        ...
        self._node.add_parameter(
            Parameter(
                ...
                input_types=["str"],
                type="str",
                tooltip="Optional second negative prompt for dual text encoders",
            )
        )
        self._node.add_parameter(
            Parameter(
    ...
    def get_pipe_kwargs(self) -> dict:
        ...
        if negative_prompt:
            ...
            kwargs["negative_prompt_2"] = self.get_negative_prompt_2()
            
        return kwargs

    def latents_to_image_pil(self, pipe: diffusers.StableDiffusionXLPipeline, latents: Any) -> Image:
    ...
    def publish_output_image_preview_latents(self, pipe: diffusers.StableDiffusionXLPipeline, latents: Any) -> None:
