...
from diffusers_nodes_library.pipelines.stable_diffusion_xl.stable_diffusion_xl_pipeline_memory_footprint import (
    optimize_stable_diffusion_xl_pipeline_memory_footprint,
)  # type: ignore[reportMissingImports]
from diffusers_nodes_library.pipelines.stable_diffusion_xl.stable_diffusion_xl_pipeline_parameters import (
    StableDiffusionXLPipelineParameters,  # type: ignore[reportMissingImports]
)
...
class StableDiffusionXLPipeline(ControlNode):
    """Griptape wrapper around diffusers.StableDiffusionXLPipeline."""

    def __init__(self, **kwargs) -> None:
        super().__init__(**kwargs)
        self.pipe_params = StableDiffusionXLPipelineParameters(self)
    ...
    def _process(self) -> AsyncResult | None:
        ...
        self.log_params.append_to_logs("Preparing Stable Diffusion XL models...\n")
        ...
        with self.log_params.append_profile_to_logs("Loading model"), self.log_params.append_logs_to_logs(logger):
            optimize_stable_diffusion_xl_pipeline_memory_footprint(pipe)
