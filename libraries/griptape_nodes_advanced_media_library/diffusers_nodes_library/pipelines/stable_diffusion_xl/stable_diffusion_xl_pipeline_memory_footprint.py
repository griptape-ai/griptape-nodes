...
def print_stable_diffusion_xl_pipeline_memory_footprint(pipe: diffusers.StableDiffusionXLPipeline) -> None:
...
@cache
def optimize_stable_diffusion_xl_pipeline_memory_footprint(pipe: diffusers.StableDiffusionXLPipeline) -> None:
    ...
    print_stable_diffusion_xl_pipeline_memory_footprint(pipe)
