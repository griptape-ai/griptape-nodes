...
class HunyuanVideoPipelineParameters:
    ...
    def add_input_parameters(self) -> None:
        ...
        self.node.add_input_parameter("num_inference_steps", default_value=30)
        self.node.add_input_parameter("guidance_scale", default_value=6.0)
        self.node.add_input_parameter("num_frames", default_value=25)
        self.node.add_input_parameter("height", default_value=480)
        self.node.add_input_parameter("width", default_value=720)
    ...
    def publish_output_video_preview_placeholder(self) -> None:
        self.node.set_output_parameter_value("output_video", "Generating video with HunyuanVideo...")
