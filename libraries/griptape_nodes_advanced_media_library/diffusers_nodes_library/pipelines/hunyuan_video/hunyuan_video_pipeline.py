...
class HunyuanVideoPipeline(ControlNode):
    """Griptape wrapper around diffusers.pipelines.hunyuan_video.HunyuanVideoPipeline."""

    def __init__(self, **kwargs) -> None:
        super().__init__(**kwargs)
        self.pipe_params = HunyuanVideoPipelineParameters(self)
    ...
    def _process(self) -> AsyncResult | None:
        ...
        with self.log_params.append_profile_to_logs("Loading model"), self.log_params.append_logs_to_logs(logger):
            optimize_hunyuan_video_pipeline_memory_footprint(pipe)
        ...
        self.pipe_params.publish_output_video(output_videos[0])
