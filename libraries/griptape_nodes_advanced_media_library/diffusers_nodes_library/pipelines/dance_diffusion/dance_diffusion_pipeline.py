...
from diffusers_nodes_library.pipelines.dance_diffusion.dance_diffusion_pipeline_memory_footprint import (
    optimize_dance_diffusion_pipeline_memory_footprint,
)  # type: ignore[reportMissingImports]
from diffusers_nodes_library.pipelines.dance_diffusion.dance_diffusion_pipeline_parameters import (
    DanceDiffusionPipelineParameters,  # type: ignore[reportMissingImports]
)
...
class DanceDiffusionPipeline(ControlNode):
    """Griptape wrapper around diffusers.DanceDiffusionPipeline."""

    def __init__(self, **kwargs) -> None:
        super().__init__(**kwargs)
        self.pipe_params = DanceDiffusionPipelineParameters(self)
    ...
    def _process(self) -> AsyncResult | None:
        self.preprocess()
        self.log_params.append_to_logs("Preparing DanceDiffusion models...\n")
        ...
        self.log_params.append_to_logs(f"Generating {audio_length}s audio with {num_inference_steps} inference steps...\n")
