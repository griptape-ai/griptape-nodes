...
def print_mochi_pipeline_memory_footprint(pipe: diffusers.MochiPipeline) -> None:
...
@cache
def optimize_mochi_pipeline_memory_footprint(pipe: diffusers.MochiPipeline) -> None:
    ...
    print_mochi_pipeline_memory_footprint(pipe)
