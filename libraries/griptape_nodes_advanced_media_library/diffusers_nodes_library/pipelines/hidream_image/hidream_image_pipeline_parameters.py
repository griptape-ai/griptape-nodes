...
class HidreamImagePipelineParameters:
    """Wrapper around the collection of parameters needed for HiDream Image pipelines."""
    ...
    def add_input_parameters(self) -> None:
        ...
        self._node.add_parameter(
            Parameter(
                ...
                input_types=["int"],
                type="int",
                tooltip="Width in pixels (should be multiple of 8)",
            )
        )
        self._node.add_parameter(
            Parameter(
                ...
                input_types=["int"],
                type="int",
                tooltip="Height in pixels (should be multiple of 8)",
            )
        )
        self._node.add_parameter(
            Parameter(
    ...
    def publish_output_image_preview_latents(self, _pipe: Any, _latents: Any) -> None:
        """TODO: Implement this method to publish a preview image from latents."""
