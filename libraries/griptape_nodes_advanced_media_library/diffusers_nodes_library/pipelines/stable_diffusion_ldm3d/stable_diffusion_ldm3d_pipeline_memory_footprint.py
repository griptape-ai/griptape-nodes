...
def print_stable_diffusion_ldm3d_pipeline_memory_footprint(pipe: diffusers.StableDiffusionLDM3DPipeline) -> None:
...
@cache
def optimize_stable_diffusion_ldm3d_pipeline_memory_footprint(pipe: diffusers.StableDiffusionLDM3DPipeline) -> None:
    ...
    print_stable_diffusion_ldm3d_pipeline_memory_footprint(pipe)
