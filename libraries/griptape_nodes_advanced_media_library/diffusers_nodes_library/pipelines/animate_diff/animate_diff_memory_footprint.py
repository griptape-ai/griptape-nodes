...
def print_animate_diff_pipeline_memory_footprint(pipe: diffusers.AnimateDiffPipeline) -> None:
...
def optimize_animate_diff_pipeline_memory_footprint(pipe: diffusers.AnimateDiffPipeline) -> None:
    ...
    print_animate_diff_pipeline_memory_footprint(pipe)
