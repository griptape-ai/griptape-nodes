...
from diffusers_nodes_library.pipelines.animate_diff.animate_diff_pipeline_parameters import AnimateDiffPipelineParameters  # type: ignore[reportMissingImports]
from diffusers_nodes_library.pipelines.animate_diff.animate_diff_memory_footprint import optimize_animate_diff_pipeline_memory_footprint
...
class AnimateDiffPipeline(ControlNode):
    ...
    def _process(self) -> AsyncResult | None:
        ...
        with self.log_params.append_profile_to_logs("Loading model metadata"):
            ...
            print("motion", motion_adapter_repo_id, motion_adapter_revision)
            motion_adapter = model_cache.from_pretrained(
                ...
                torch_dtype=torch.float16,  # TODO: can we use bfloat16 here?
