...
class AnimateDiffPipelineParameters:
    ...
    def add_input_parameters(self):
        self._motion_adapter_repo_parameter.add_parameter()
        self._model_repo_parameter.add_parameter()
    ...
    def get_motion_adapter_repo_revision(self):
        return self._motion_adapter_repo_parameter.get_repo_revision()
    
    def get_model_repo_revision(self):
    ...
    def publish_output_video_mp4(self, video_mystery_format: Any, fps):
    ...
    def publish_output_video_gif(self, video_mystery_format: Any, fps):
        ...
        gif_artifact = VideoUrlArtifact(url=gif_url, name=gif_filename)
