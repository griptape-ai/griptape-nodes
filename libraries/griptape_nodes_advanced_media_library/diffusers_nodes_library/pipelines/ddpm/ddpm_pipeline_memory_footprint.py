...
def print_ddpm_pipeline_memory_footprint(pipe: diffusers.DDPMPipeline) -> None:
...
@cache
def optimize_ddpm_pipeline_memory_footprint(pipe: diffusers.DDPMPipeline) -> None:
    ...
    print_ddpm_pipeline_memory_footprint(pipe)
