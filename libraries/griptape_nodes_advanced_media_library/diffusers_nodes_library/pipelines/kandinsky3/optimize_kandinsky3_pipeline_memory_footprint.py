...
def print_kandinsky3_pipeline_memory_footprint(
    pipe: diffusers.Kandinsky3Pipeline | diffusers.Kandinsky3Img2ImgPipeline,  # type: ignore[reportMissingImports]
) -> None:
    """Print memory footprint for the main sub-modules of Kandinsky 3 pipelines."""
...
def optimize_kandinsky3_pipeline_memory_footprint(
    ...
    The logic follows the same rationale as the optimisation helper for the Flux
    pipelines but adapted to the component layout of Kandinsky 3.
    """
