...
from diffusers_nodes_library.pipelines.kandinsky3.kandinsky3_pipeline_parameters import (
    Kandinsky3PipelineParameters,  # type: ignore[reportMissingImports]
)
...
class Kandinsky3Pipeline(ControlNode):
    ...
    def _process(self) -> AsyncResult | None:
        ...
        with self.log_params.append_profile_to_logs("Loading model metadata"):
            ...
            pipe: diffusers.Kandinsky3Pipeline = model_cache.from_pretrained(
        ...
        with (
            ...
            optimize_kandinsky3_pipeline_memory_footprint(pipe)
