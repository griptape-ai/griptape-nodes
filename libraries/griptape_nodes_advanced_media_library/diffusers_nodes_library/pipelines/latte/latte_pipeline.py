...
class LattePipeline(ControlNode):
    ...
    def _process(self) -> AsyncResult | None:
        ...
        with self.log_params.append_profile_to_logs("Loading model metadata"):
            ...
            pipe: diffusers.LattePipeline = model_cache.from_pretrained(
        ...
        with (
            ...
            optimize_latte_pipeline_memory_footprint(pipe)
        ...
        logger.info("Latte memory footprint after inference:")
