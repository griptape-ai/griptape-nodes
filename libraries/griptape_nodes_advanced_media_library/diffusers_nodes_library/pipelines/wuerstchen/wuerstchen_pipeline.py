...
from diffusers_nodes_library.pipelines.wuerstchen.wuerstchen_pipeline_memory_footprint import (
    optimize_wuerstchen_pipeline_memory_footprint,
)  # type: ignore[reportMissingImports]
from diffusers_nodes_library.pipelines.wuerstchen.wuerstchen_pipeline_parameters import (
    WuerstchenPipelineParameters,  # type: ignore[reportMissingImports]
)
    ...
    def _process(self) -> AsyncResult | None:
        ...
        with self.log_params.append_profile_to_logs("Loading model metadata"):
            ...
            pipe = model_cache.from_pretrained(
                diffusers.WuerstchenCombinedPipeline,
        ...
        with self.log_params.append_profile_to_logs("Loading model"), self.log_params.append_logs_to_logs(logger):
            optimize_wuerstchen_pipeline_memory_footprint(pipe)
