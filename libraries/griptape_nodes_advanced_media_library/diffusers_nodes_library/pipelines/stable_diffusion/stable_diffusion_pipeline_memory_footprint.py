...
def print_stable_diffusion_pipeline_memory_footprint(pipe: diffusers.StableDiffusionPipeline) -> None:
...
@cache
def optimize_stable_diffusion_pipeline_memory_footprint(pipe: diffusers.StableDiffusionPipeline) -> None:
