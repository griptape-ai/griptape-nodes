...
class LTXImageToVideoPipelineParameters:
    """Wrapper around the collection of parameters needed for LTX Video pipelines."""
    ...
    def add_input_parameters(self) -> None:
        ...
        self._node.add_parameter(
            Parameter(
                ...
                input_types=["int"],
                type="int",
                tooltip="Width in pixels (should be multiple of 32)",
            )
        )
        self._node.add_parameter(
            Parameter(
                ...
                input_types=["int"],
                type="int",
                tooltip="Height in pixels (should be multiple of 32)",
            )
        )
        self._node.add_parameter(
            Parameter(
    ...
    def get_frame_rate(self) -> int:
        return int(self._node.get_parameter_value("frame_rate"))
