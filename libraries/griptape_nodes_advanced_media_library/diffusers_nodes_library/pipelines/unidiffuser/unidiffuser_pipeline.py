...
class UnidiffuserPipeline(ControlNode):
    """Griptape wrapper around diffusers.pipelines.unidiffuser.UniDiffuserPipeline."""

    def __init__(self, **kwargs) -> None:
        super().__init__(**kwargs)
        self.pipe_params = UnidiffuserPipelineParameters(self)
    ...
    def _process(self) -> AsyncResult | None:
        ...
        with self.log_params.append_profile_to_logs("Loading model"), self.log_params.append_logs_to_logs(logger):
            optimize_unidiffuser_pipeline_memory_footprint(pipe)
