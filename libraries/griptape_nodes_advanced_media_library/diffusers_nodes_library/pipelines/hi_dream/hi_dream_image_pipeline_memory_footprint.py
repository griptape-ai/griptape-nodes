...
def print_hi_dream_pipeline_memory_footprint(pipe: diffusers.AmusedPipeline) -> None:
...
def optimize_hi_dream_pipeline_memory_footprint(pipe: diffusers.HiDreamImagePipeline) -> None:
    ...
    print_hi_dream_pipeline_memory_footprint(pipe)
