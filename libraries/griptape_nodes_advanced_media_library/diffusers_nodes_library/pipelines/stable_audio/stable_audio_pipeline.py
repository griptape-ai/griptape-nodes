...
from diffusers_nodes_library.pipelines.stable_audio.stable_audio_pipeline_parameters import (
    StableAudioPipelineParameters,  # type: ignore[reportMissingImports]
)
from diffusers_nodes_library.pipelines.stable_audio.optimize_stable_audio_pipeline_memory_footprint import (
    optimize_stable_audio_pipeline_memory_footprint,
...
class StableAudioPipeline(ControlNode):
    """Griptape wrapper around diffusers.StableAudioPipeline."""
    
    def __init__(self, **kwargs) -> None:
        super().__init__(**kwargs)
        self.pipe_params = StableAudioPipelineParameters(self)
    ...
    def _process(self) -> AsyncResult | None:
        self.preprocess()
        self.log_params.append_to_logs("Preparing Stable Audio models...\n")
