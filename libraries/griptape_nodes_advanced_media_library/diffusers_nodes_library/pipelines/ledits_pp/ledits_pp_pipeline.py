...
from diffusers_nodes_library.pipelines.ledits_pp.ledits_pp_pipeline_memory_footprint import (
    optimize_ledits_pp_pipeline_memory_footprint,  # type: ignore[reportMissingImports]
    print_ledits_pp_pipeline_memory_footprint,  # type: ignore[reportMissingImports]
)
from diffusers_nodes_library.pipelines.ledits_pp.ledits_pp_pipeline_parameters import (
    LeditsPpPipelineParameters,  # type: ignore[reportMissingImports]
)
...
class LeditsPpPipeline(ControlNode):
    """Griptape wrapper around diffusers.LEditsPPPipelineStableDiffusion."""

    def __init__(self, **kwargs) -> None:
        super().__init__(**kwargs)
        self.pipe_params = LeditsPpPipelineParameters(self)
    ...
    def _process(self) -> AsyncResult | None:
        ...
        with self.log_params.append_profile_to_logs("Loading model metadata"):
            ...
            pipe: diffusers.LEditsPPPipelineStableDiffusion = model_cache.from_pretrained(
                diffusers.LEditsPPPipelineStableDiffusion,
        ...
        with (
            ...
            optimize_ledits_pp_pipeline_memory_footprint(pipe)
        ...
        def callback_on_step_end(
            pipe: diffusers.LEditsPPPipelineStableDiffusion,
            step: int,
            _timestep: int,
        ...
        logger.info("LEDITS++ memory footprint after inference:")
