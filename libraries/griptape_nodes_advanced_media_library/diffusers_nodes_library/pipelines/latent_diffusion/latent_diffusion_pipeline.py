...
from diffusers_nodes_library.pipelines.latent_diffusion.latent_diffusion_pipeline_memory_footprint import (
    optimize_latent_diffusion_pipeline_memory_footprint,  # type: ignore[reportMissingImports]
    print_latent_diffusion_pipeline_memory_footprint,  # type: ignore[reportMissingImports]
)
from diffusers_nodes_library.pipelines.latent_diffusion.latent_diffusion_pipeline_parameters import (
    LatentDiffusionPipelineParameters,  # type: ignore[reportMissingImports]
)
...
class LatentDiffusionPipeline(ControlNode):
    """Griptape wrapper around diffusers.LDMTextToImagePipeline."""

    def __init__(self, **kwargs) -> None:
        super().__init__(**kwargs)
        self.pipe_params = LatentDiffusionPipelineParameters(self)
    ...
    def _process(self) -> AsyncResult | None:
        ...
        with self.log_params.append_profile_to_logs("Loading model metadata"):
            ...
            pipe: diffusers.LDMTextToImagePipeline = model_cache.from_pretrained(
        ...
        with (
            ...
            optimize_latent_diffusion_pipeline_memory_footprint(pipe)
        ...
        logger.info("LatentDiffusion memory footprint after inference:")
