...
def print_hunyuandit_pipeline_memory_footprint(
    pipe: diffusers.HunyuanDiTPipeline,  # type: ignore[reportMissingImports]
) -> None:
    """Print memory footprint for the main sub-modules of HunyuanDiT pipelines."""
...
def optimize_hunyuandit_pipeline_memory_footprint(
    ...
    pipelines but adapted to the component layout of HunyuanDiT.
    """
