...
from diffusers_nodes_library.pipelines.hunyuandit.hunyuandit_pipeline_memory_footprint import (
    optimize_hunyuandit_pipeline_memory_footprint,  # type: ignore[reportMissingImports]
    print_hunyuandit_pipeline_memory_footprint,  # type: ignore[reportMissingImports]
)
from diffusers_nodes_library.pipelines.hunyuandit.hunyuandit_pipeline_parameters import (
    HunyuanditPipelineParameters,  # type: ignore[reportMissingImports]
)
...
class HunyuanditPipeline(ControlNode):
    """Griptape wrapper around diffusers.HunyuanDiTPipeline."""

    def __init__(self, **kwargs) -> None:
        super().__init__(**kwargs)
        self.pipe_params = HunyuanditPipelineParameters(self)
    ...
    def _process(self) -> AsyncResult | None:
        ...
        with self.log_params.append_profile_to_logs("Loading model metadata"):
            ...
            pipe: diffusers.HunyuanDiTPipeline = model_cache.from_pretrained(
        ...
        with (
            ...
            optimize_hunyuandit_pipeline_memory_footprint(pipe)
        ...
        logger.info("HunyuanDiT memory footprint after inference:")
        print_hunyuandit_pipeline_memory_footprint(pipe)
