...
class ConsisidPipelineParameters:
    ...
    def publish_output_video_preview_placeholder(self) -> None:
        ...
        self._node.publish_update_to_parameter("video", video_artifact)
    ...
    def validate_before_node_run(self) -> list[Exception]:
        ...
        if num_frames > MAX_FRAMES:
            errors.append(ValueError(f"Number of frames should not exceed {MAX_FRAMES} for memory reasons"))
