...
from diffusers_nodes_library.pipelines.consisid.consisid_pipeline_memory_footprint import (
    optimize_consisid_pipeline_memory_footprint,
)  # type: ignore[reportMissingImports]
from diffusers_nodes_library.pipelines.consisid.consisid_pipeline_parameters import (
    ConsisidPipelineParameters,  # type: ignore[reportMissingImports]
)
...
class ConsisidPipeline(ControlNode):
    """Griptape wrapper around diffusers.pipelines.consisid.ConsisIDPipeline."""

    def __init__(self, **kwargs) -> None:
        super().__init__(**kwargs)
        self.pipe_params = ConsisidPipelineParameters(self)
    ...
    def _process(self) -> AsyncResult | None:
        ...
        self.log_params.append_to_logs("Preparing ConsisID models...\n")
        ...
        with self.log_params.append_profile_to_logs("Loading model"), self.log_params.append_logs_to_logs(logger):
            optimize_consisid_pipeline_memory_footprint(pipe)
