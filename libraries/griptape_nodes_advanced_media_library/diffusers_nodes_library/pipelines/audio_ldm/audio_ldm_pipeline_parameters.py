...
from diffusers_nodes_library.utils.parameter_utils import HuggingFaceRepoParameter, AudioUrlArtifact
...
class AudioLDMPipelineParameters:
    ...
    def get_audio_length_in_s(self):
    ...
    def publish_output_audio(self, audio: Any):
        self.publish_output_wav(audio)


    def publish_output_wav(self, audio: Any):
        ...
        audio_artifact = AudioUrlArtifact(url=audio_url, name=audio_filename)
