...
from diffusers_nodes_library.pipelines.audio_ldm.audio_ldm_pipeline_parameters import AudioLDMPipelineParameters  # type: ignore[reportMissingImports]
from diffusers_nodes_library.pipelines.audio_ldm.audio_ldm_memory_footprint import optimize_audio_ldm_pipeline_memory_footprint
...
class AudioLDMPipeline(ControlNode):
    ...
    def _process(self) -> AsyncResult | None:
        ...
        def callback(i: int, _t: Any, latents: torch.Tensor) -> dict:
