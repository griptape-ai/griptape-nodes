...
def print_i2vgen_xl_pipeline_memory_footprint(
    pipe: diffusers.I2VGenXLPipeline,  # type: ignore[reportMissingImports]
) -> None:
    """Print memory footprint for the main sub-modules of I2VGen-XL pipelines."""
...
def optimize_i2vgen_xl_pipeline_memory_footprint(
    ...
    pipelines but adapted to the component layout of I2VGen-XL.
    """
