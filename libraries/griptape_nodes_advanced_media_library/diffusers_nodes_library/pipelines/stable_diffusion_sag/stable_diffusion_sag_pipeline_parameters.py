...
class StableDiffusionSagPipelineParameters:
    ...
    def add_input_parameters(self) -> None:
        ...
        self._node.add_parameter(
            Parameter(
                ...
                input_types=["float"],
                type="float",
                tooltip="Self-attention guidance scale. Higher values enhance quality but may reduce diversity",
            )
        )
    ...
    def get_sag_scale(self) -> float:
        return float(self._node.get_parameter_value("sag_scale"))
    ...
    def latents_to_image_pil(self, pipe: diffusers.StableDiffusionSAGPipeline, latents: Any) -> Image:
    ...
    def publish_output_image_preview_latents(self, pipe: diffusers.StableDiffusionSAGPipeline, latents: Any) -> None:
