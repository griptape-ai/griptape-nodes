...
def print_stable_diffusion_sag_pipeline_memory_footprint(pipe: diffusers.StableDiffusionSAGPipeline) -> None:
...
@cache
def optimize_stable_diffusion_sag_pipeline_memory_footprint(pipe: diffusers.StableDiffusionSAGPipeline) -> None:
    ...
    print_stable_diffusion_sag_pipeline_memory_footprint(pipe)
