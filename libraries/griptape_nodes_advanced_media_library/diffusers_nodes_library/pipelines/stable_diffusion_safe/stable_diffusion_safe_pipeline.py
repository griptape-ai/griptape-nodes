...
from diffusers_nodes_library.pipelines.stable_diffusion_safe.stable_diffusion_safe_pipeline_memory_footprint import (
    optimize_stable_diffusion_safe_pipeline_memory_footprint,
)  # type: ignore[reportMissingImports]
from diffusers_nodes_library.pipelines.stable_diffusion_safe.stable_diffusion_safe_pipeline_parameters import (
    StableDiffusionSafePipelineParameters,  # type: ignore[reportMissingImports]
)
...
class StableDiffusionSafePipeline(ControlNode):
    ...
    def __init__(self, **kwargs) -> None:
        ...
        self.pipe_params = StableDiffusionSafePipelineParameters(self)
    ...
    def _process(self) -> AsyncResult | None:
        ...
        self.log_params.append_to_logs("Preparing Stable Diffusion Safe models...\n")
        ...
        with self.log_params.append_profile_to_logs("Loading model"), self.log_params.append_logs_to_logs(logger):
            optimize_stable_diffusion_safe_pipeline_memory_footprint(pipe)
