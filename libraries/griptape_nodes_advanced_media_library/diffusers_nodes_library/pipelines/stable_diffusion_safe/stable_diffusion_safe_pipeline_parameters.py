...
class StableDiffusionSafePipelineParameters:
    ...
    def latents_to_image_pil(self, pipe: diffusers.StableDiffusionSafePipeline, latents: Any) -> Image:
    ...
    def publish_output_image_preview_latents(self, pipe: diffusers.StableDiffusionSafePipeline, latents: Any) -> None:
