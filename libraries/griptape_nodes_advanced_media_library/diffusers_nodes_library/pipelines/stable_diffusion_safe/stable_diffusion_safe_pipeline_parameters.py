...
class StableDiffusionSafePipelineParameters:
    ...
    def latents_to_image_pil(self, pipe: diffusers.StableDiffusionPipelineSafe, latents: Any) -> Image:
    ...
    def publish_output_image_preview_latents(self, pipe: diffusers.StableDiffusionPipelineSafe, latents: Any) -> None:
