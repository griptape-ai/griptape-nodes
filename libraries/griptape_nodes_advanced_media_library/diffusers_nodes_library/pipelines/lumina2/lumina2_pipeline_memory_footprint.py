...
def print_lumina2_pipeline_memory_footprint(pipe: diffusers.Lumina2Text2ImgPipeline) -> None:
...
@cache
def optimize_lumina2_pipeline_memory_footprint(pipe: diffusers.Lumina2Text2ImgPipeline) -> None:
    """Optimize pipeline memory footprint."""
    device = get_best_device()

    if not torch.cuda.is_available():
        raise RuntimeError("CUDA is required for Lumina2 pipeline optimization")
    ...
    print_lumina2_pipeline_memory_footprint(pipe)