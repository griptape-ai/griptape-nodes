...
from diffusers_nodes_library.utils.torch_utils import get_best_device, print_pipeline_memory_footprint  # type: ignore[reportMissingImports]
...
def print_amused_pipeline_memory_footprint(pipe: diffusers.AmusedPipeline) -> None:
...
def optimize_amused_pipeline_memory_footprint(pipe: diffusers.AmusedPipeline) -> None:
    ...
    # TODO:
    # if hasattr(pipe, "vqvae"):
    #     logger.info("Enabling vqvae slicing")
    #     pipe.vqvae.enable_slicing()
