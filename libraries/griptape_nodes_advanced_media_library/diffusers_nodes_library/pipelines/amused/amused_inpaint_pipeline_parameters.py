...
from diffusers_nodes_library.utils.parameter_utils import HuggingFaceRepoParameter  # type: ignore[reportMissingImports]
...
class AmusedInpaintPipelineParameters:
    ...
    def get_mask_image(self):
        ...
        logger.warning(f"resizing mask image to 512x512 for model compatibility")
        mask_image_pil = mask_image_pil.resize((512, 512))  # TODO: This is dumb for many reasons
