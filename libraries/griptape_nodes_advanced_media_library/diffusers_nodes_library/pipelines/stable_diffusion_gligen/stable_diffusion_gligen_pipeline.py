...
class StableDiffusionGligenPipeline(ControlNode):
    """Griptape wrapper around diffusers.pipelines.stable_diffusion_gligen.StableDiffusionGLIGENPipeline."""

    def __init__(self, **kwargs) -> None:
        super().__init__(**kwargs)
        self.pipe_params = StableDiffusionGligenPipelineParameters(self)
    ...
    def _process(self) -> AsyncResult | None:
        ...
        with self.log_params.append_profile_to_logs("Loading model"), self.log_params.append_logs_to_logs(logger):
            optimize_stable_diffusion_gligen_pipeline_memory_footprint(pipe)
