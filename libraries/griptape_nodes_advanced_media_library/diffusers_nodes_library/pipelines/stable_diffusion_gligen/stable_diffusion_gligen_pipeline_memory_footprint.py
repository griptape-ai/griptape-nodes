...
def print_stable_diffusion_gligen_pipeline_memory_footprint(pipe: diffusers.StableDiffusionGLIGENPipeline) -> None:
...
@cache
def optimize_stable_diffusion_gligen_pipeline_memory_footprint(pipe: diffusers.StableDiffusionGLIGENPipeline) -> None:
    ...
    print_stable_diffusion_gligen_pipeline_memory_footprint(pipe)
