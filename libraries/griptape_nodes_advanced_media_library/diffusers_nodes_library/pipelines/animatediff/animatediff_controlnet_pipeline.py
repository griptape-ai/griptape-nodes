...
from diffusers_nodes_library.pipelines.animatediff.animatediff_controlnet_pipeline_memory_footprint import (  # type: ignore[reportMissingImports]
    optimize_animatediff_controlnet_pipeline_memory_footprint,
    print_animatediff_controlnet_pipeline_memory_footprint,
)
from diffusers_nodes_library.pipelines.animatediff.animatediff_controlnet_pipeline_parameters import (  # type: ignore[reportMissingImports]
    AnimateDiffControlNetPipelineParameters,
)
...
class AnimateDiffControlNetPipeline(ControlNode):
    """Griptape wrapper around diffusers.AnimateDiffControlNetPipeline (text-to-video with ControlNet)."""

    def __init__(self, **kwargs) -> None:
        super().__init__(**kwargs)
        self.pipe_params = AnimateDiffControlNetPipelineParameters(self)
    ...
    def _process(self) -> AsyncResult | None:
        ...
        with self.log_params.append_profile_to_logs("Loading model metadata"):
            ...
            # Now load the main AnimateDiffControlNet pipeline with base Stable-Diffusion model.
            pipe: diffusers.AnimateDiffControlNetPipeline = model_cache.from_pretrained(
                diffusers.AnimateDiffControlNetPipeline,
        ...
        with (
            ...
            optimize_animatediff_controlnet_pipeline_memory_footprint(pipe)
        ...
        logger.info("AnimateDiffControlNet memory footprint after inference:")
