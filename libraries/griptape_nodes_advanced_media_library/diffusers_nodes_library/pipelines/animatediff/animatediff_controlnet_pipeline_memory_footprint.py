...
ANIMATEDIFF_CONTROLNET_PIPELINE_COMPONENT_NAMES = [
    "vae",
    "text_encoder",
    "unet",
    "motion_adapter",
...
def print_animatediff_controlnet_pipeline_memory_footprint(
    ...
    """Print memory footprint for the main sub-modules of AnimateDiffControlNet pipelines."""
    print_pipeline_memory_footprint(pipe, ANIMATEDIFF_CONTROLNET_PIPELINE_COMPONENT_NAMES)
...
def optimize_animatediff_controlnet_pipeline_memory_footprint(
    ...
    model_memory = get_total_memory_footprint(pipe, ANIMATEDIFF_CONTROLNET_PIPELINE_COMPONENT_NAMES)
    ...
    if device.type == "cuda":
        ...
        logger.info("Require memory for AnimateDiffControlNet Pipeline: %s", to_human_readable_size(model_memory))
