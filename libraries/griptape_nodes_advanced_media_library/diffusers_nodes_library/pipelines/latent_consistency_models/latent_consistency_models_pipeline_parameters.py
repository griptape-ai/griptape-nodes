...
class LatentConsistencyModelsPipelineParameters:
    """Wrapper around the collection of parameters needed for Latent Consistency Models pipelines."""
    ...
    def add_input_parameters(self) -> None:
        ...
        self._node.add_parameter(
            Parameter(
                ...
                input_types=["int"],
                type="int",
                tooltip="Number of denoising steps (LCM uses very few steps)",
            )
        )
