...
def print_stable_video_diffusion_pipeline_memory_footprint(
    pipe: diffusers.StableVideoDiffusionPipeline,  # type: ignore[reportMissingImports]
) -> None:
    """Print memory footprint for the main sub-modules of Stable Video Diffusion pipelines."""
...
def optimize_stable_video_diffusion_pipeline_memory_footprint(
    ...
    pipelines but adapted to the component layout of Stable Video Diffusion.
    """
