...
from griptape_nodes_advanced_media_library.diffusers_nodes_library.common.parameters.diffusion.allegro.allegro_pipeline_type_allegro_pipeline_parameters import (
