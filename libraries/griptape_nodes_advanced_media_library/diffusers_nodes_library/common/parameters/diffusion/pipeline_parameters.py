...
from diffusers_nodes_library.common.parameters.diffusion.ltx2.text2vid_runtime_parameters import (
    LTX2TextToVideoPipelineRuntimeParameters,
)
...
from diffusers_nodes_library.common.parameters.diffusion.qwen.layered_runtime_parameters import (
    QwenLayeredPipelineRuntimeParameters,
)
...
class DiffusionPipelineParameters:
    ...
    def set_runtime_parameters(self, pipeline_class: str) -> None:  # noqa: C901 PLR0912 PLR0915
        match pipeline_class:
            ...
            case "LTXTextToVideoPipeline":
                self._runtime_parameters = LTX2TextToVideoPipelineRuntimeParameters(self._node)
            ...
            case "QwenImageLayeredPipeline":
                self._runtime_parameters = QwenLayeredPipelineRuntimeParameters(self._node)
