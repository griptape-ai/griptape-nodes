...
class MarigoldNormalsPipelineRuntimeParameters:
    ...
    def add_output_parameters(self) -> None:
        self._node.add_parameter(
            Parameter(
                ...
                tooltip="RGB-encoded surface normals visualization",
    ...
    def process_pipeline(self, pipe: DiffusionPipeline) -> None:
        ...
        normals_prediction = result.prediction

        vis_images = pipe.image_processor.visualize_normals(normals_prediction)
