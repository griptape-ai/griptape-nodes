...
class AmusedPipelineTypeAmusedInpaintPipelineParameters(DiffusionPipelineTypePipelineParameters):
    ...
    def pipeline_class(self) -> type:
        return diffusers.AmusedInpaintPipeline

    def validate_before_node_run(self) -> list[Exception] | None:
        errors = self._model_repo_parameter.validate_before_node_run()
        return errors or None

    def build_pipeline(self) -> diffusers.AmusedInpaintPipeline:
        repo_id, revision = self._model_repo_parameter.get_repo_revision()
        return diffusers.AmusedInpaintPipeline.from_pretrained(
