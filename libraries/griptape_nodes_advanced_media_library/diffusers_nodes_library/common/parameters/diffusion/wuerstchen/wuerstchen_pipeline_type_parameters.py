...
from griptape_nodes_advanced_media_library.diffusers_nodes_library.common.parameters.diffusion.wuerstchen.wuerstchen_pipeline_type_wuerstchen_pipeline_parameters import (
