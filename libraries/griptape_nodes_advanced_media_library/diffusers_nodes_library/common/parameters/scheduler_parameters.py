...
class SchedulerParameters:
    def __init__(
        self,
        node: BaseNode, 
        scheduler_types: list[Type[diffusers.SchedulerMixin]]
    ):
        self._node = node
    ...
    def remove_input_parameters(self):
    ...
    def get_config_kwargs(self) -> dict:
        return {
            ...
            self._scheduler_config_parameter_name: self._node.get_parameter_value(self._scheduler_config_parameter_name),
        }
    ...
    def get_scheduler_config(self) -> dict:
        scheduler_config_json = self._node.get_parameter_value(self._scheduler_config_parameter_name)
        if scheduler_config_json is None:
            return {}
        return json.loads(scheduler_config_json)
