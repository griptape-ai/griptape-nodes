    ...
    def _image_to_bytes(self, image_artifact: ImageArtifact | ImageUrlArtifact | dict) -> bytes:
        ...
        try:
            ...
            if isinstance(image_artifact, dict):
                ...
                return load_content_from_url(image_url_artifact.value)
            # Handle ImageUrlArtifact - use load_content_from_url for file:// support
            if isinstance(image_artifact, ImageUrlArtifact):
                return load_content_from_url(image_artifact.value)
