...
class QwenImageEdit(GriptapeProxyNode):
    ...
    def __init__(self, **kwargs: Any) -> None:
        ...
        self._output_file_param = ProjectFileParameter(
            ...
            default_filename="qwen_edit.png",
        )
    ...
    async def _save_image_from_url(self, image_url: str) -> None:
        ...
        try:
            ...
            self._set_status_results(
                was_successful=True,
                result_details=f"Image edited successfully. Using provider URL (could not save file: {e}).",
            )
            return
        ...
        self._set_status_results(
            was_successful=True,
            result_details=f"Image edited successfully and saved as {Path(actual_path).name}.",
        )
