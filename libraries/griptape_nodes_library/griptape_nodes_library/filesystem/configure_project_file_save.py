...
class ConfigureProjectFileSave(BaseNode):
    ...
    Outputs a File object with an unresolved MacroPath so that path resolution
    happens at I/O time via the File class.
    """
    ...
    def _create_parameters(self) -> None:
        ...
        self.file_location = Parameter(
            ...
            default_value=None,
            allowed_modes={ParameterMode.OUTPUT},
            tooltip="File object with unresolved macro path for downstream save nodes",
            output_type="File",
        )
