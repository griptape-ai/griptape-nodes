...
class OmnihumanSubjectRecognition(GriptapeProxyNode):
    ...
    def _get_api_model_id(self) -> str:
        ...
        return self.get_parameter_value("model_id") or "omnihuman-1-5-subject-recognition"

    async def _build_payload(self) -> dict[str, Any]:
        """Build the request payload for subject recognition."""
        # Get image URL
    ...
    async def _parse_result(self, result_json: dict[str, Any], _generation_id: str) -> None:
        """Parse subject recognition result."""
        ...
        result_msg = f"Subject recognition completed successfully. Contains subject: {contains_human}"
        self._set_status_results(
            was_successful=True,
    ...
    async def aprocess(self) -> None:
        """Process subject recognition with cleanup."""
        try:
