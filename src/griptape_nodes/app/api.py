...
@app.delete("/static-uploads/{file_path:path}")
async def _delete_static_file(
    _request: Request, file_path: str, static_directory: Annotated[Path, Depends(get_static_dir)]
) -> dict:
