...
class ParameterVideo(Parameter):
    ...
    def __init__(  # noqa: PLR0913
        ...
        *,
        ...
        # Set up video conversion based on accept_any setting
    ...
    def _accept_any(self, value: Any) -> Any:
        """Convert any input value to a video-compatible format.

        Args:
            value: The value to convert to video format

        Returns:
            Video-compatible representation of the value
        """
        # For now, just return the value as-is since video handling
        # is typically done by the underlying video processing libraries
        return value
