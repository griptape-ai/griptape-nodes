...
class ListConnectionsForNodeRequest(RequestPayload):
    ...
    Args:
        ...
        include_internal: Whether to include internal connections (connections where both nodes are in the same selection/duplication set). Defaults to True.
    ...
    # Whether to include internal connections (defaults to True for backward compatibility)
