    ...
    def handle_engine_heartbeat_request(self, request: EngineHeartbeatRequest) -> ResultPayload:
        ...
        try:
            ...
            return EngineHeartbeatResultSuccess(
                ...
                instance_region=instance_info["instance_region"],
                instance_provider=instance_info["instance_provider"],
                deployment_type=instance_info["deployment_type"],
                public_ip=instance_info.get("public_ip"),
                current_workflow=workflow_info["current_workflow"],
                workflow_file_path=workflow_info["workflow_file_path"],
                has_active_flow=workflow_info["has_active_flow"],
