...
def _download_and_run_installer() -> None:
    ...
    try:
        ...
        console.print(f"[red]Error during update: return code={e.returncode}, stdout={e.stdout}, stderr={e.stderr}[/red]")
        raise
    else:
        console.print("[green]Finished updating self.[/green]")
...
def _sync_libraries() -> None:
    ...
    try:
        ...
        console.print(f"[red]Error during libraries sync: return code={e.returncode}, stdout={e.stdout}, stderr={e.stderr}[/red]")
        raise
    else:
